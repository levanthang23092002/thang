...
public class listview extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new person("Lê văn Thắng","thượng ý","Đà Nẵng",R.drawable.congan,R.drawable.img_1,R.drawable.bon_sao));
        arrayList.add(new person("Lê văn Thắng","thượng ý","Đà Nẵng",R.drawable.congan,R.drawable.img_1,R.drawable.bon_sao));
        arrayList.add(new person("Lê văn Thắng","thượng ý","Đà Nẵng",R.drawable.congan,R.drawable.img_1,R.drawable.bon_sao));
        arrayList.add(new person("Lê văn Thắng","thượng ý","Đà Nẵng",R.drawable.congan,R.drawable.img_1,R.drawable.bon_sao));
        arrayList.add(new person("Lê văn Thắng","thượng ý","Đà Nẵng",R.drawable.congan,R.drawable.img_1,R.drawable.bon_sao));
        arrayList.add(new person("Lê văn Thắng","thượng ý","Đà Nẵng",R.drawable.congan,R.drawable.img_1,R.drawable.bon_sao));
        adapter = new adapter(getContext(),R.layout.list_item,arrayList);
